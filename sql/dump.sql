<<<<<<< HEAD
-- mysqldump --user=root -p --add-drop-database --complete-insert --dump-date --events --force --hex-blob --opt --add-drop-table --add-locks --create-options --disable-keys --extended-insert=1 --quick --set-charset --skip-lock-tables --order-by-primary --quote-names --single-transaction --tz-utc --verbose --result-file=dump.sql --databases sidigrupoChr

-- MySQL dump 10.17  Distrib 10.3.22-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: sidigrupoChr
-- ------------------------------------------------------
...
--
-- Current Database: `sidigrupoChr`
--

/*!40000 DROP DATABASE IF EXISTS `sidigrupoChr`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `sidigrupoChr` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
--
-- Dumping events for database 'sidigrupoChr'
--

--
-- Dumping users and grants
--
CREATE USER IF NOT EXISTS grupoChr@'%' IDENTIFIED WITH mysql_native_password BY 'aula';
GRANT ALL PRIVILEGES ON sidigrupoChr.* TO grupoChr@'%';
...
GRANT ALL PRIVILEGES ON sidi-groupoChr.* TO aula@'%';
